...
public class Controller {
    ...
    void onViewReBtnClickedAdmin(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("ViewReservationAdmin.fxml"));
            Parent root = loader.load();
            Stage stage = (Stage) loginAnchorPane.getScene().getWindow();
            stage.setScene(new Scene(root));
            stage.setTitle("Admin-View-Reservation");
            Controller newController = loader.getController();
    ...
    @FXML
    void onBackAdminBtnClicked(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("AdminAfterLogin.fxml"));
            Parent root = loader.load();
            Stage stage = (Stage) loginAnchorPane.getScene().getWindow();
        ...
        if (!flag){
            ...
            joinButton.setOnAction(e -> {
                if ((event.getEventOrginizer().equals(me))){
                    ...
                    alert.setHeaderText(null);
                    alert.setContentText("you are Event " + event.getEventId() + " Organizer.");
                    alert.showAndWait();
                }
                else if (!((event.getRoom().getGender().equals("Male") && me.isGender()) || (event.getRoom().getGender().equals("Female") && (!me.isGender())))){
                    Alert alert = new Alert(Alert.AlertType.INFORMATION);
                    alert.setTitle("Join Failed");
                    alert.setHeaderText(null);
                    alert.setContentText("the Event " + event.getEventId() + " is for "+ event.getRoom().getGender() + "s.");
                    alert.showAndWait();
                }
